...
USER_CPU_SRCS =\
  ...
  $(wildcard src/$(LOGIN)/mips_cpu_*/mips_cpu_*.c) \
  $(wildcard src/$(LOGIN)/mips_cpu_*/mips_cpu_*.cpp) \
...
src/$(LOGIN)/test_mips : $(DEFAULT_OBJECTS) $(USER_CPU_OBJECTS) $(USER_CPU_OBJECTS)
